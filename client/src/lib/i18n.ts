...
const resources = {
  ru: {
    translation: {
      ...
      days: "дней",
      simultaneousSessions: "Одновременные сессии",
      maxSessions: "Макс. сессий",
      timelineEvents: "События на таймлайне",
      walk: "Прогулка",
      classroom: "Группа",
      playback: "Воспроизведение",
      selectCamera: "Выберите камеру",
      liveDemo: "Прямой эфир (DEMO)",
      nurseryGroup: "Ясельная группа",
      playground: "Игровая площадка",
      diningRoom: "Столовая",
      bedroom: "Спальня",
      onlineStatus: "Онлайн",
      cameraDescription: "Прямой эфир и архив из детского сада",
      exportDialogDescription: "Настройте параметры экспорта клипа",
      archiveDescription: "Доступ к записям за последние 7-30 дней",
      archiveInterface: "Интерфейс архива (DEMO)",
      selectDateTime: "Выбор даты и времени для просмотра записей",
      technicalInfo: "Техническая информация",
      supportedFormats: "Поддерживаемые форматы:",
      formatsList: "RTSP/ONVIF (камеры), HLS/DASH (VOD), WebRTC (live)",
      gardenSettings: "в настройках",
      gardenParams: "параметры сада",
      autoFaceBlur: "Автоматическое размытие лиц",
    }
  },
  kk: {
    translation: {
      ...
      // Cameras
      liveView: "Тікелей эфир",
      archive: "Мұрағат",
      allCameras: "Барлық камералар",
      qualityIndicator: "Сапа",
      latency: "Кідіріс",
      signalLost: "Сигнал жоғалды",
      reconnecting: "Қайта қосылу...",
      exportClip: "Клипті экспорттау",
      privacyMode: "Құпиялылық режимі",
      faceBlur: "Беттерді бұлдырлату",
      watermark: "Су белгісі",
      clipDuration: "Клип ұзақтығы",
      exportSettings: "Экспорт баптаулары",
      generateLink: "Сілтеме жасау",
      linkExpiry: "Сілтеме мерзімі",
      archiveRetention: "Мұрағатты сақтау",
      days: "күн",
      simultaneousSessions: "Бір мезгілдегі сеанстар",
      maxSessions: "Макс. сеанстар",
      timelineEvents: "Таймлайндағы оқиғалар",
      walk: "Серуен",
      classroom: "Топ",
      playback: "Ойнату",
      selectCamera: "Камера таңдаңыз",
      liveDemo: "Тікелей эфир (DEMO)",
      nurseryGroup: "Сәбилер тобы",
      playground: "Серуен алаңы",
      diningRoom: "Асхана",
      bedroom: "Ұйқы бөлмесі",
      onlineStatus: "Онлайн",
      cameraDescription: "Балабақшадағы тікелей эфир мен мұрағат",
      exportDialogDescription: "Клипті экспорттау параметрлерін орнатыңыз",
      archiveDescription: "7-30 күнге дейін жазбаларға қол жеткізу",
      archiveInterface: "Мұрағат интерфейсі (DEMO)",
      selectDateTime: "Күн мен уақытты таңдап, жазбаларды қарау",
      technicalInfo: "Техникалық ақпарат",
      supportedFormats: "Қолдау көрсетілетін форматтар:",
      formatsList: "RTSP/ONVIF (камералар), HLS/DASH (VOD), WebRTC (live)",
      gardenSettings: "баптауда",
      gardenParams: "сад параметрлері",
      autoFaceBlur: "Автоматты бет бұлдырлау",
    }
  }
};
